...
namespace GraniteHouse.Areas.Customer.Controllers
{
    ...
    public class ShoppingCartController : Controller
    {
        ...
        {
            ShoppingCartVM.Appointments = _db.Appointments
                                            .Where(a => a.Id == id)
                                            .FirstOrDefault();

            List<ProductsSelectedForAppointment> productsSelectedForAppointments = _db.ProductsSelectedForAppointments
                                                                                    .Where(p => p.AppointmentId == id)
                                                                                    .ToList();

            foreach(ProductsSelectedForAppointment product in productsSelectedForAppointments)
            {
